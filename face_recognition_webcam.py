...
face_detector = dlib.cnn_face_detection_model_v1('./model/mmod_human_face_detector.dat')
face_landmark_5_points = dlib.shape_predictor('./model/shape_predictor_5_face_landmarks.dat')
face_encoder = dlib.face_recognition_model_v1('./model/dlib_face_recognition_resnet_model_v1.dat')

video_capture = cv2.VideoCapture(0)
keep_running = True

guolong_image = cv2.imread('./images/guolong.jpg')[:, :, ::-1]
